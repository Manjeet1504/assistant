...
if __name__ =='__main__':
    ...
    while(1):
        ...
        if 'wikipedia' in query:
            ...
            music_dir="C:\\Users\\Manjeet Bhatia\\Music\\Haryanv"
        ...
        elif 'email to Manjeet' in query:
            try: 
            ...
            speak("I have been created by Mister Manjeet.")
            ...
            query= search.replace('search','')
            query= play.replace('play','')
            ...
            speak("I am your virtual assistant created by Manjeet")
 
        elif 'reason for you' in query:
            speak("I was created as a Minor project by Mister Manjeet ")
            ...
            speak("for how much time you want to stop listening me")
            a=int(takeCommand())
            time.sleep(a)
            print(a)
            ...
            ec.capture(0,'jarvis camera','img1.jpg')
        ...
        # most asked question from google Assistant
            ...
            client = wolframalpha.Client("14431ba7f26b19ff4a5d8a176f9c522d")
